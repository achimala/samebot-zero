      ...
      messages: [
        {
          role: "system",
          content:
            "Generate a single creative portmanteau or variation that includes 'dank' anywhere in the word (beginning, middle, or end) and is contextually relevant to the recent conversation. Use the conversation context to make your variation more specific and less repetitive. Respond with only the word, nothing else.",
        },
        {
          role: "user",
